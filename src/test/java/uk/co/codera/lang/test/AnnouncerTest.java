...
public class AnnouncerTest {
	...
	@Before
	public void setUp() {
		this.announcer = announcerWithDefaultExceptionPolicyAndListenersRegistered()
				.useExceptionHandler(this.exceptionHandler);
	}

	@Test
	public void shouldBeAbleToConstructAnnouncerWithMultipleListenersUpFront() {
		assertThat(Announcer.to(Listener.class, Arrays.asList(this.listener1, this.listener2)).numberListeners(),
				is(2));
	}
